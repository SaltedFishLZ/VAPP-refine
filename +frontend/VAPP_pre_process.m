function [tok_list, new_macro_definitions] = ...
            VAPP_pre_process(infile_path, macro_definitions, parms)
...
%==============================================================================
    ...
    s = frontend.VAPP_file_to_str(infile_path);
    s_1 = s;
    ...
    s = frontend.VAPP_combine_lines(s, parms);
    s_2 = s;
    
    % Step 3: Strip comments
    s = frontend.VAPP_strip_comments(s);
    s_3 = s;
    ...
    [tok_list, new_macro_definitions, new_context_stack] = ...
        frontend.VAPP_tokenize(s, macro_definitions, context_stack, ...
